...
class OpenpayErrorHandler {
    ...
    public static function handleOpenpayPluginException($exception, $order_id, $customer_id = null) {
    ...
    public static function catchOpenpayError($callback, $order_id, $customer_id = null) {
        try {
            return $callback();
